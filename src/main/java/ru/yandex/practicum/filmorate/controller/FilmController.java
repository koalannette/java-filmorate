...
public class FilmController {
    ...
    public Film createFilm(@RequestBody Film film) {
        ...
        log.info("Поступил запрос на добавление фильма. Фильм " + film.getId() + " добавлен");
        return film;
    }
    ...
    public Film updateFilm(@RequestBody Film film) {
        ...
        if (films.get(film.getId()) != null) {
            films.put(film.getId(), film);
            log.info("Поступил запрос на изменения фильма. Фильм " + film.getId() + " изменён.");
        } else {
            log.error("Поступил запрос на изменения фильма. Фильм " + film.getId() + " не найден.");
